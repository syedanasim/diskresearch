def it_acolor_plot_retro(): #this one
    fig=plt.figure(figsize=(6,5))
    vmin=1e3; vmax=1e4; norm=matplotlib.colors.LogNorm(vmax=vmax, vmin=vmin)
    ...
    ax1.scatter(capturedata_1e4_n45_rgiant_SG[3],capturedata_1e4_n45_rgiant_SG[1],
        ...
        norm=norm)
    #delta=ax1.scatter(capturedata_1e4_135_sBH_SG[3],capturedata_1e4_135_sBH_SG[1],
    #    marker='.',label='sBH', c=capturedata_1e4_135_sBH_SG[0]/Rg, cmap='ocean_r', #plasma_r
    #    norm=norm)
    ...
    #    marker='.',label='r giant', c=capturedata_1e4_135_rgiant_TQM[0]/Rg, cmap='ocean_r',
    #    norm=norm)
    #ax2.scatter(capturedata_1e4_135_sBH_TQM[3],capturedata_1e4_135_sBH_TQM[1],
    #    marker='.',label='sBH', c=capturedata_1e4_135_sBH_TQM[0]/Rg, cmap='ocean_r',
    #    norm=norm)
    #matplotlib.pyplot.annotate('rgiant', (2e8,10))
    #matplotlib.pyplot.annotate('sBH', (4e9,10))
    #plt.xscale('log')
    ...
    plt.savefig('plots/propertyplots/it_retro.pdf')
    plt.savefig('plots/propertyplots/it_retro.jpeg')
...
def stitch_plot_stellar():
    ...
    ax2.plot(capturedata_i_mstar_SG[0], capturedata_i_mstar_SG[1],'*',label='M Dwarf',
        markersize=12, markerfacecolor='darkorange', markeredgewidth=0.1, markeredgecolor='k')
    matplotlib.pyplot.annotate('$a_{0} = 10^{4}~R_g$', (3,1e3))
